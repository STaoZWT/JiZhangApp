      ...
      mainAxisAlignment: MainAxisAlignment.start,
        children: <Widget>[
          Padding(
            ...
            child: Text("Welcome to Back!",style: TextStyle(color: Colors.black,fontSize: 35.0)),
          ),
          Padding(
            ...
            child: Card(
              ...
              child: FlatButton(
                onPressed: () async{
                  ...
                  if(passwordInSp == _PassWordController.value.text.toString()) {
                    showDialog<Null>(
                        context: context,
          ...
          Container(
            ...
            child: Card(
              ...
              child: FlatButton(
                ...
                child: Padding(
                  padding: EdgeInsets.all(10.0),
                  child: Text("Graphic login",style: TextStyle(color: Colors.black,fontSize: 20.0),),
                ),
              ),
            ),
          ),
