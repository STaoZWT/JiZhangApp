      ...
      body: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text("Reset your password",style: TextStyle(color: Colors.black,fontSize: 30.0)),
          ),
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(hintText: "Please input Your New Password Here"),
              obscureText: true,
            ),
          ),
          Container(
            ...
            child: Card(
              ...
              child: FlatButton(
                onPressed: () async{
                  if(resetPassWordController.value.text.toString().length>=8&&resetPassWordController.value.text.toString().length<=18) {
                    await setPassWord(resetPassWordController.value.text.toString());
                    showDialog<Null>(
                        context: context,
